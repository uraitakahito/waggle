...
submits, waits, and reports; capture-ledger plans the next level and records what
happened. There is no BrowserHive address in capture-ledger's configuration at all.
